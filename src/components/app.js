...
class App extends Component {
  constructor(props) {
    ...
    const availablePlayers = [
      ...
      { id: 7,  name: 'Thomas', isActive: true }, { id: 8,  name: 'Trisha', isActive: true },
    ...
    this.state = {
                  activePlayers: availablePlayers.filter(function(player){ return player.isActive === true; }),
                  inactivePlayers: availablePlayers.filter(function(player){ return player.isActive === false; }),
                };
  }
  render() {
      return (
        <div>
          ...
          <div id="active-players">
            <PlayerList players={this.state.activePlayers} />
          </div>

          <h3>Inactive Players</h3>
          <div id="inactive-players">
            <PlayerList players={this.state.inactivePlayers} />
          </div>
