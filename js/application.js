...
if(playerProfile)
  ...
  ReactDOM.render(
    React.createElement(PlayerProfile, {player: availablePlayers.filter(function(player){ return player.id == queryString.id })}),
    playerProfile
  );
...
module.exports = React.createClass({displayName: "exports",
  render() {
    ...
    return (
      React.createElement("div", {key: this.props.player.id}, 
        React.createElement(Player, React.__spread({},  playerProfile))
      )
    )
  }
});
